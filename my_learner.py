...
__all__ = ['load_all', 'load_learner_all', 'get_arch', 'all_archs_names']
...
@patch
@delegates(subplots)
def plot_metrics(self: Recorder, nrows=None, ncols=None, figsize=None, final_losses=True, perc=.5, path=None, **kwargs):

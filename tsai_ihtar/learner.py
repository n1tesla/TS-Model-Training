...
@patch
@delegates(subplots)
def plot_metrics(self: Recorder, nrows=None, ncols=None, figsize=None, final_losses=True, perc=.5,save_path=None, **kwargs):
    ...
    print("PLOT_METRIC FROM TSAI_IHTAR")
    plt.savefig(save_path+"\\lossacc.png")
    # plt.show()

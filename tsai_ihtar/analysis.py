...
@patch
@delegates(subplots)
def show_probas(self:Learner, figsize=(6,6), ds_idx=1, dl=None, one_batch=False, max_n=None,save_path=None, **kwargs):
    ...
    plt.savefig(save_path+"\\dist_of_probas.png")
    # plt.show()
...
def step_importance(
    ...
    if show_chart:
        ...
        plt.savefig(save_path+"\\step_importance.png")
        # plt.show()
